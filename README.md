...
预览地址：http://sdmht-dev.star2000.work
...
3. [打开 Construct3 编辑器](https://editor.construct.net)
4. 点击展开`打开文件`，点击`项目文件夹`，选择仓库目录，点击`打开`，注意保存

## 关于提交

使用代码编辑器 [Trae](https://www.trae.cn/) 打开仓库目录，点源代码管理，写提交描述，然后点提交，此时修改会在本地存档，如果要发布到线上，继续点同步
